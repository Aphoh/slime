    ...
    def _update_bucket_weights_from_distributed(
        ...
        *,
        ...
        if sync_tensor_model_parallel:
            # Keep collective ordering consistent while the source rank
            # broadcasts the bucket to rollout engines.
            barrier_t0 = time.time()
...
def update_weights_from_distributed(
    ...
    """
    use_flattened_bucket = os.getenv("SLIME_WEIGHT_UPDATE_FLATTENED_BUCKET", "1") == "1" and load_format is None
